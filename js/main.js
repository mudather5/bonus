...
var array = ["the have to go right now"];
...
findLongestWord("the have to go right now");
...
var tache = [];
var reponce = "fin";
while (tache === [prompt("quelle tâche vous dovez réaliser")]){
    prompt("quelle tâche vous dovez réaliser")
    if (reponce === "fin"){
        console.log("les tâches à réaliser dans la console");
        }else{
            console.log("");
        }
}
